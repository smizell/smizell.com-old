...
I also wanted to direct people to look at [Webmachine](https://github.com/seancribbs/webmachine-ruby), which starts with the idea of resources first instead of starting with the database. It does a great job of fixing some of the issues that I've outlined in this document, and I think Rails could glean a lot moving toward organizing code around resources.